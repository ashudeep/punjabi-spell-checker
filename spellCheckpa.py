...
alphabet = 'ਔਐਆਈਊਭਙਘਧਝਢਞਠਛਥਖੜਫਉਇਅਏਓਁੰਣਨਵਲ਼ਸ਼ੱੌੈਾੀੂਬਹਗਦਜ਼ਡ਼ਟਚਤਕਰਪੁਿ੍ੇੋਂਮਨਵਲਸਯ'
...
Pw = Pdist(datafile('filtered_list.pun'), N, avoid_long_words)
...
P1edit = Pdist(datafile('pa_edits_count.txt')) ## Probabilities of single edits
